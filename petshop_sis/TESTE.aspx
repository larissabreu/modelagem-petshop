<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TESTE.aspx.vb" Inherits="petshop_sis.TESTE" %>
...
<body>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      ...
      <a href="cad_Cliente.aspx" class="btn btn-primary btn-lg">Call to action!</a>--%>
    </header>
    ...
    <div class="row text-center">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-70">
          ...
          <div class="card-body">
            <h4 class="card-title">REALIZAR CADASTROS</h4>
            <p class="card-text"></p>
          </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-70">
          ...
          <div class="card-body">
            <h4 class="card-title">CARTÃO PET</h4>
            <p class="card-text"></p>
          </div>
          <div class="card-footer">
            <a href="#" class="btn btn-primary">Find Out More!</a>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card h-70">
          ...
          <div class="card-body">
            <h4 class="card-title">REGISTRO DE ANÁLISE</h4>
            <p class="card-text"></p>
          </div>
          <div class="card-footer">
            <a href="#" class="btn btn-primary">Find Out More!</a>
